      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center">
          <div className="flex justify-center items-center space-x-2 mb-4">
            ...
            <p className="text-green-400 font-semibold text-lg">100% Private & Secure</p>
          </div>
          <p className="text-gray-400 text-sm mb-4 max-w-2xl mx-auto">
            All data is processed locally in your browser using client-side JavaScript. Nothing is
            uploaded to any server. Your purchase history stays completely private.
          </p>
